...
class Ping extends React.Component {
  ...
  render(){
    ...
    const { dispatch, todos } = this.props; // 获得接口数据以及 redux dispatch函数
        ...
        <div className={styles.wrapper}>
          <div className={styles.breadcrumb}>
            <Breadcrumb>
              ...
              <Breadcrumb.Item>Ping</Breadcrumb.Item>
            </Breadcrumb>
          </div>
          <div className={styles.container}>
            <div className={styles.content}>
              <Form horizontal onSubmit={handleSubmit}>
                ...
                >
                  <Button type="primary" loading={add_loading} size="large" htmlType="submit" onClick={changeLoading}>创建</Button>
                  &nbsp;&nbsp;&nbsp;
