        ...
        <div className={styles.wrapper}>
          <div className={styles.breadcrumb}>
            <Breadcrumb>
              ...
              <Breadcrumb.Item>Http</Breadcrumb.Item>
            </Breadcrumb>
          </div>
                    ...
                    <Panel header="更多高级设置" style={{border:'none', fontSize: '12px', color: 'rgba(153, 153, 153, 0.65098)' }}>
                      <Form horizontal>
                          <FormItem
                            ...
                            wrapperCol= {{ span: 8 }}
                          >
                              <RadioGroup className={styles.sub_form_item} onChange={select_http_method} defaultValue={'get'}>
                                <Radio value={'get'}>GET</Radio>
                                <Radio value={'post'}>POST</Radio>
                                <Radio value={'header'}>HEAD</Radio>
                              </RadioGroup>
                          </FormItem>
                          ...
                          >
                              <Input type="textarea" className={styles.sub_form_item} placeholder="输入POST内容,以'&'分隔" autosize={{ minRows: 5, maxRows: 8 }} onChange={setBody} />
                          </FormItem>
                          ...
                          <FormItem
                            ...
                            wrapperCol= {{ span: 8 }}
                          >
                              <Input type="textarea" className={styles.sub_form_item} placeholder="可以指定Cookies字符串,以';'分隔" autosize={{ minRows: 5, maxRows: 8 }} onChange={setCookies} />
                          </FormItem>
                          ...
                          <FormItem
                            ...
                            wrapperCol= {{ span: 8 }}
                          >
                              <Input type="textarea" className={styles.sub_form_item} placeholder="可以自定义HTTP请求头信息,以';'分隔" autosize={{ minRows: 5, maxRows: 8 }} onChange={setHeaders} />
                          </FormItem>
                          ...
                          <FormItem
                            ...
                            wrapperCol= {{ span: 8 }}
                          >
                              <Checkbox className={styles.sub_form_item_checkbox} onChange={is_redirect}>支持301/302重定向</Checkbox>
                          </FormItem>
                          ...
                          <FormItem
                            ...
                            labelCol= {{ span: 6 }}
                            wrapperCol= {{ span: 8 }}
                            style={this.state.showredirtime ? { display: "block" } : { display: "none" }}
                          >
                              <RadioGroup className={styles.sub_form_item} onChange={select_redirect_times} defaultValue={'3'}>
...
export default connect(mapStateToProps)(Http);
