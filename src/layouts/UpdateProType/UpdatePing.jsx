...
class UpdatePing extends Component{
        ...
        <div className={styles.wrapper}>
          <div className={styles.breadcrumb}>
            <Breadcrumb>
              ...
              <Breadcrumb.Item>修改Ping</Breadcrumb.Item>
            </Breadcrumb>
          </div>
...
UpdatePing.propTypes = {};

UpdatePing = Form.create({})(UpdatePing);
...
export default connect(mapStateToProps)(UpdatePing);